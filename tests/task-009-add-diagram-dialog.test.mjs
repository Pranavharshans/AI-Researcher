...
assert.match(shell, /generating diagram with OpenRouter/, "Submission must call the configured OpenRouter generation route");
assert.match(shell, /createFallbackGeneratedDiagram/, "Submission must keep a local fallback if live generation fails");
